...
import { verifyOTP, validateOTP } from "../store/actions/authAction";
...
const TwoFactorAuth = ({ closeModal }) => {
  ...
  useEffect(() => {
    if (auth) QRCode.toDataURL(auth.user.otp_url).then(setqrCodeUrl);
  }, []);
        ...
        <div className="relative bg-white rounded-lg shadow">
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <p className="text-sm">
                SecretKey: {auth.user.otp_code} (Base32 encoded)
              </p>
            </div>
            <div>
